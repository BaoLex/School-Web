						...
						<tbody>
							<tr>
								<?php if ($row["status"]=="Unpaid") { ?>
									...
									<td><span class="status process"><a href="./notify.php?id=<?=$row['student_id']?>">Notify</a></span></td>
									<td><span class="status completed"><a href="./collect.php?id=<?=$row['fee_id']?>">Collect</a></span></td>
                                <?php } ?>
							</tr>
						</tbody>
						<?php
