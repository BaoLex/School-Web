	...
	<section id="content">
		...
		<main>
            ...
            <div class="table-data">
				<div class="order">
					<div class="head">
						<h3>Attach new homework</h3>
					</div>
                    <form action="../controller/attach_homework_controller.php" method="post">
						<div class="input-box">
						...
						<div class="input-box">
							<input type="url" name="link" placeholder="Attach link here" required>
						</div>
                        <div class="input-box">
